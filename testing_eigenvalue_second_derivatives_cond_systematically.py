...
for order1 in permute:
    for order2 in permute:
        ...
        print("Current Iteration: {}".format(len(residuals_k)))
        print(order1, order2)
                ...
                for k in range(test_size):
                    for l in range(test_size):
                        ...
                        for curr_eig in range(len(all_eig_vals)):
                            ...
                            if (order1 == (0, 1, 3, 2)) and (order2 == (2, 0, 1, 3)):
                                i_def = len(store_orders)
...
print(store_orders[i_min])
print("Residuals from min: ")
print(np.log(abs(np.array(residuals_k[i_min]))))
